...
class TpmTestFirmware(FirmwareBlock):
    ...
    def send_csp_data(self, samples_per_packet, number_of_samples):
        ...
        if self._device_name == "fpga1":
            ...
            self.board[0x10315004] = self.board[0x10319004] | 0x1       
            self.board[0x10315004] = self.board[0x10319004] & 0xFFFFFFFE

        if self._device_name == "fpga1":
            self.board[0x319004] = self.board[0x319004] | 0x1
            self.board[0x319004] = self.board[0x319004] & 0xFFFFFFFE
        else:
